 ...
 <div class="container mt-5 ml-7">
   <a href="/pesb" class="btn btn-primary" >Kembali</a>
   <br>
   <br>
   <div class="row g-3">
    <div class="col">
    ...
    <div class="col">
      ...
      <input type="text" class="form-control " id="nama" name="nama" value=" {{ ($customers->status == 1) ? 'Dibayar' : 'Belum Bayar' }} " readonly>
    </div>
    <div class="col">
  ...
  <table class="table">
    ...
    <tbody>
     ...
     <tr>
        {{-- <strong>Pesanan {{ $loop->iteration }}</strong><br>
        {{ $cust->pesanan }} | {{ $cust->berat }} | {{ $cust->total }}<br> --}}
        {{-- <td>{{ ($cust->status == 1) ? 'Dibayar' : 'Belum Bayar'}}</td> --}}
