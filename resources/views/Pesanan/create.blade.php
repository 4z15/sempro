...
@section('konten')
    ...
    <body>
        ...
        <div class="container mt-2">
            <div class="row">
                <div class="col-md-12">
                    <a href="/pesanan" class="btn btn-info mb-3">
                        <i class="fas fa-arrow-left"></i>
                    </a>
                </div>
            </div>

            <form action="/pesanan/with-model" method="post" class="row g-3" id="formPesanan">
                @csrf
                {{-- <div class="container"> --}}
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            {{-- <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="telp" name="telp"
                                    value="{{ old('telp') }}" placeholder="No Telp">
                            </div> --}}
                            <div class="col-md-6">
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('#cariSayur').on('input', function() {
                    ...
                    if (keyword.length > 0) {
                        $.ajax({
                            url: '/pesanan/cari-sayur/' + keyword,
                            type: 'GET',
